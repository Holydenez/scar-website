...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    if (!a.jQuery) {
        ...
        for (var e = {}, f = e.hasOwnProperty, g = e.toString,
                 h = "Boolean Number String Function Array Date RegExp Object Error".split(" "),
                 i = 0; i < h.length; i++)e["[object " + h[i] + "]"] = h[i].toLowerCase();
    ...
    return function (a, b, c, d) {
        ...
        function l(a, b) {
            ...
            for (var c = t.State.calls[a][0], e = t.State.calls[a][1], f = t.State.calls[a][2], h = t.State.calls[a][4],
                     i = !1, j = 0, k = c.length; k > j; j++) {
                var l = c[j].element;
                        ...
                        g(f).tweensContainer && g(f).isAnimating === !0 && (F = g(f).tweensContainer), m.each(q, function (a, b) {
                            if (RegExp("^" + v.Lists.colors.join("$|^") + "$").test(a)) {
                                ...
                                if (v.RegEx.isHex.test(e)) {
                                    for (var h = ["Red", "Green", "Blue"], i = v.Values.hexToRgb(e),
                                             j = g ? v.Values.hexToRgb(g) : d, k = 0; k < h.length; k++) {
                                        var m = [i[k]];
    ...
    for (var b = 0, c = ["webkit", "moz"], d = a.requestAnimationFrame, e = a.cancelAnimationFrame,
             f = c.length; --f >= 0 && !d;)d = a[c[f] + "RequestAnimationFrame"], e = a[c[f] + "CancelRequestAnimationFrame"];
    d && e || (d = function (a) {
...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, function (a) {
    ...
    function e(a) {
        ...
        if (b.classList.add("toast"), c)for (var e = c.split(" "), f = 0,
                                                 g = e.length; f < g; f++)b.classList.add(e[f]);
        ...
        init: function (b) {
            ...
            b = a.extend(c, b), a(this).each(function () {
                ...
                b.draggable && (f.on("click", function () {
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        var d = a("#sidenav-overlay"), g = c.gesture.velocityX, j = c.gesture.center.x,
    ...
    a(document).ready(function () {
        ...
        a(f).each(function () {
            ...
            for (var b = a(this).closest(".file-field"), c = b.find("input.file-path"), d = a(this)[0].files, e = [],
                     f = 0; f < d.length; f++)e.push(d[f].name);
        ...
        a(document).on("change", g, function (b) {
            ...
            var d = a(this).attr("max"), e = a(this).width() - 15,
                f = (a(this).parent(".range-field").outerWidth() - e || 0, a(this).val() * (e / d));
            ...
            var c = a(this).siblings(".thumb"), d = a(this).attr("max"), e = a(this).width() - 15,
                f = (a(this).parent(".range-field").outerWidth() - e || 0, a(this).val() * (e / d));
            ...
            var c = a(this).children(".thumb"), d = a(this).find(g), e = d.attr("max"), f = d.width() - 15,
                i = (a(this).outerWidth() - f || 0, d.val() * (f / e));
                ...
                var i = a('<ul id="select-options-' + g + '" class="dropdown-content select-dropdown ' + (e ? "multiple-select-dropdown" : "") + '"></ul>'),
                    ...
                    n = function (b, c, d) {
                        var f = c.is(":disabled") ? "disabled " : "",
                            ...
                            h = e ? '<input type="checkbox"' + f + "/><label></label>" : "", j = c.data("icon"),
                            k = c.attr("class");
                        if (j) {
                            var l = "";
    ...
    var b = {
        init: function (b) {
            ...
            return this.each(function (c) {
                ...
                var q, r, s, t, u, v, w, x, z, A, B, C, D, E, F, G, H, I, J, K = d + c,
                    L = a('<ul class="indicators"></ul>'), M = a(this), N = M.attr("data-indicators") || b.indicators;
        ...
        init: function (b) {
            return this.each(function () {
                ...
                var i = function () {
                    ...
                    if (!b)for (var g = c.parents(),
                                    i = 0; i < g.length && !(b = "fixed" == a(g[i]).css("position")); i++);
                    var j = c.outerWidth(), k = c.outerHeight(),
                        l = b ? c.offset().top - a(document).scrollTop() : c.offset().top,
                        m = b ? c.offset().left - a(document).scrollLeft() : c.offset().left, n = a(window).width(),
                        o = a(window).height(), p = n / 2, q = o / 2, r = m <= p, s = m > p, t = l <= q, u = l > q,
                        v = m >= .25 * n && m <= .75 * n, w = d.outerWidth(), x = d.outerHeight(),
                        y = l + k / 2 - x / 2, z = m + j / 2 - w / 2, A = b ? "fixed" : "absolute",
                        B = v ? w : w / 2 + j, C = x / 2, D = t ? x / 2 : 0, E = 0, F = r && !v ? w / 2 - j : 0, G = 0,
                        H = j, I = u ? "bottom" : "top", J = j > k ? 2 * j : 2 * j, K = J, L = x / 2 - K / 2,
                        M = w / 2 - J / 2, N = {};
